...
public class HttpsUtil {
	...
	public static byte[] httpMethodPostFile(String url, String params, String gb) {
		...
		URL urls = null;
		HttpsURLConnection uc = null;
        btFile = getBytes(url, gb, params, btFile, uc);
        return btFile;
	}
	...
	public static String httpMethodPost(String url,
		...
		try {
            ...
            if (respCode == HttpsURLConnection.HTTP_OK
                    || respCode == HttpsURLConnection.HTTP_CREATED || respCode == HttpsURLConnection.HTTP_ACCEPTED) {
            ...
            in = new BufferedReader(new InputStreamReader(inputStream, gb));
			String readLine = "";
			while ((readLine = in.readLine()) != null) {
				sb.append(readLine);
			}
    ...
    private static byte[] getBytes(String url, String gb, String params, byte[] btFile, HttpsURLConnection uc) {
        URL urls;
        try {
            SSLContext sc = SSLContext.getInstance("SSL");
            sc.init(null, new TrustManager[] { new MyTrustManager() },
